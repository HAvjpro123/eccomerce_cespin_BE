...
public class AdminOrderController {
	...
	public ResponseEntity<Order>DeliverOrdeHandler(@PathVariable Long orderId,
			@RequestHeader("Authorization") String jwt) throws OrderException {
	...
	public ResponseEntity<Order>CancelOrdeHandler(@PathVariable Long orderId,
			@RequestHeader("Authorization") String jwt) throws OrderException {
	...
	public ResponseEntity<ApiResponse>DeleteOrdeHandler(@PathVariable Long orderId,
			@RequestHeader("Authorization") String jwt) throws OrderException {
