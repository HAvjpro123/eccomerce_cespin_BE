...
public class Order {
	...
	public Order(Long id, String orderId, User user, List<OrderItem> orderItems, LocalDateTime orderDate,
			...
			Integer totalDiscountedPrice, Integer discoute, String orderStatus, int totalItem, LocalDateTime createAt) {
		super();
		this.id = id;
	...
	public Integer getDiscoute() {
		return discoute;
	}


	public void setDiscoute(Integer discoute) {
		this.discoute = discoute;
	}
